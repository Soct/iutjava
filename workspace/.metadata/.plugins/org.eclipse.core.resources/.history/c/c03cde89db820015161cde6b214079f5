...
public class OutilsJDBC {
	...
	public static void main(final String[] args) {
		...
		System.out.println("Voici les différent acteur(s) :");
		afficher(resultat);
		...
		requete = "SELECT Titre FROM ens2004.FILM fi, ens2004.ACTEUR ac WHERE fi.NUMFILM = ac.NUMFILM AND NUMINDIVIDU = '" + choix + "' ";
		resultat = OutilsJDBC.exec1Requete(requete, co, 0);
		...
		requete = "SELECT fi.NUMFILM FROM ens2004.FILM fi, ens2004.ACTEUR ac WHERE fi.NUMFILM = ac.NUMFILM AND NUMINDIVIDU = '" + choix + "' ";
		resultat = OutilsJDBC.exec1Requete(requete, co, 0);
		choix2 = film(choix2, resultat);


		System.out.println("Voici les numéro des exemplaire(s) disponible(s) :");
